...
const FullScreenMap = Control.extend({
    ...
    onAdd: () => {
        ...
        container.style.backgroundColor = '#ede9e9';
        ...
        container.onmouseenter = () => container.style.backgroundColor = '#d7cece';

        container.onmouseout = () => container.style.backgroundColor = '#ede9e9';
